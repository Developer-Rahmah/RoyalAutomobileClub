      ...
      <ContainerView>
        ...
        >
          ...
          <View style={General.horizontalPadding}>
            <Title title='Discover Our Latest Offers and discounts in our Club' numberOfLines={2} small />
          </View>
        </ImageAndTextContainer>
        <BtnIndicatorAndSkipContainer>
          ...
          <Button onClick={() => navigation.navigate('ViewPagerJoinUs')} txtColor={Colors.WHITE} title='Continue' />
          <SkipContainer
          >
