      ...
      <ContainerView>
        ...
        >
          ...
          <View style={General.horizontalPadding}>
            <Title title='Discover our services and Facilities that we offer to our members' numberOfLines={2} small />
          </View>
        </ImageAndTextContainer>
        <BtnIndicatorAndSkipContainer>
          ...
          <Button onClick={() => navigation.navigate('ViewPagerOffer')} txtColor={Colors.WHITE} title='Continue' />
          <SkipContainer
          >
            <Title title='Skip' color={Colors.ORANGE} style={{ marginEnd: 3 }} />
            <IconImage source={RightArrow} small style={{ marginStart: 3, resizeMode: 'contain' }} />
